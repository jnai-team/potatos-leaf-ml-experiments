...
#
#
# File: /Users/hain/chatopera/chatopera.xinli/alchemist/app/thirdparty/environs/__init__.py
# Author: Hai Liang Wang
# Date: 2020-03-24:14:27:09
#
# ===============================================================================

"""
加载环境变量
API文档：https://github.com/hailiang-wang/python-environ
"""
__all__ = ["EnvError", "Env", "__version__", "__copyright__", "__date__"]
__version__ = "7.3.1"
__copyright__ = "Copyright (c) 2020 Chatopera Inc. All Rights Reserved"
__author__ = "Hai Liang Wang"
__date__ = "2020-03-24:14:27:09"
...
class Env:
    ...
    def _get_from_environ(
        ...
        The ``proxied`` flag is recursively passed if a brain lookup is required to get a
        brain env key.
        """
